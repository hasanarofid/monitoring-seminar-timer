...
// ============================================
// EDIT BAGIAN INI DENGAN KREDENSIAL DATABASE ANDA
// 
// Untuk hosting Anda (contoh):
// DB_HOST: localhost (biasanya selalu localhost)
// DB_USER: solz1468_solkit (username database Anda)
// DB_PASSWORD: DemiAllah@1 (password database Anda)
// DB_NAME: solz1468_monitoring (nama database Anda)

define('DB_HOST', 'localhost');        // Biasanya 'localhost'
define('DB_USER', 'root');             // GANTI dengan username database Anda
define('DB_PASSWORD', '');             // GANTI dengan password database Anda
define('DB_NAME', 'monitoring_seminar'); // GANTI dengan nama database Anda
